...
echo "  Mobile customer: ${DEMO_CUSTOMER_EMAIL:-customer@skillserve.test} / ${DEMO_ACCOUNT_PASSWORD:-SkillServe#2026}"
echo "  Mobile provider: ${DEMO_PROVIDER_EMAIL:-provider@skillserve.test} / ${DEMO_ACCOUNT_PASSWORD:-SkillServe#2026}"
