...
| *(exempt)* | no limit | — | `POST /api/webhooks/paymongo` — PayMongo controls delivery including retries; throttling it would drop genuine payment events. Protected by signature verification instead |
